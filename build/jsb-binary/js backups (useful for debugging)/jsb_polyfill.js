...
"./cocos2d/core/platform/CCEnum": 128
} ],
2: [ (function(t, e, i) {}), {} ],
3: [ (function(i, n, o) {
function r(t, e) {
...
var s = i("./utils/prefab-helper"), c = i("./utils/scene-graph-helper"), a = i("./event-manager"), l = cc.Object.Flags, h = l.Destroying, u = "position-changed", d = "size-changed", f = "anchor-changed", _ = "rotation-changed", p = "scale-changed", g = i("./utils/misc"), y = i("./event/event"), v = !!cc.ActionManager, m = function() {}, C = cc.Enum({
...
}), T = [ C.TOUCH_START, C.TOUCH_MOVE, C.TOUCH_END, C.TOUCH_CANCEL ], b = [ C.MOUSE_DOWN, C.MOUSE_ENTER, C.MOUSE_MOVE, C.MOUSE_LEAVE, C.MOUSE_UP, C.MOUSE_WHEEL ], S = null, E = function(t, e) {
var i = t.getLocation(), n = this.owner;
if (n._hitTest(i, this)) {
(e = y.EventTouch.pool.get(e)).type = C.TOUCH_START;
e.touch = t;
e.bubbles = !0;
n.dispatchEvent(e);
e.touch = null;
...
t.stopPropagation();
(t = y.EventMouse.pool.get(t)).type = C.MOUSE_DOWN;
t.bubbles = !0;
i.dispatchEvent(t);
y.EventMouse.pool.put(t);
}
}, L = function(t) {
var e = t.getLocation(), i = this.owner, n = i._hitTest(e, this);
if (n || this._previousIn) {
t.stopPropagation();
t = y.EventMouse.pool.get(t);
}
if (n) {
if (!this._previousIn) {
if (S) {
t.type = C.MOUSE_LEAVE;
S.dispatchEvent(t);
S._mouseListener._previousIn = !1;
}
S = this.owner;
t.type = C.MOUSE_ENTER;
i.dispatchEvent(t);
this._previousIn = !0;
}
t.type = C.MOUSE_MOVE;
...
if (i._hitTest(e, this)) {
t.stopPropagation();
(t = y.EventMouse.pool.get(t)).type = C.MOUSE_UP;
t.bubbles = !0;
i.dispatchEvent(t);
y.EventMouse.pool.put(t);
}
...
if (i._hitTest(e, this)) {
t.stopPropagation();
(t = y.EventMouse.pool.get(t)).type = C.MOUSE_WHEEL;
t.bubbles = !0;
i.dispatchEvent(t);
y.EventMouse.pool.put(t);
}
...
-1 !== T.indexOf(t) ? this._checkTouchListeners() : -1 !== b.indexOf(t) && this._checkMouseListeners();
},
...
if (!(this._objFlags & h) && this._touchListener) {
var t = 0;
...
cc.director.once(cc.Director.EVENT_BEFORE_UPDATE, P, this);
}
}), !0);
g.propertyDefine(R, [ "parent", "tag", "skewX", "skewY", "position", "rotation", "rotationX", "rotationY", "scale", "scaleX", "scaleY", "opacity", "color" ], {
...
"./utils/base-node": 147,
"./utils/misc": 151,
"./utils/prefab-helper": 153,
"./utils/scene-graph-helper": 154
} ],
16: [ (function(t, e, i) {
cc.Scene = cc.Class({
name: "cc.Scene",
...
"./CCCircleCollider": 32,
"./CCCollider": 33,
"./CCCollisionManager": 34,
"./CCPolygonCollider": 37
} ],
39: [ (function(i, n, o) {
function r(t, e) {
...
var o = i[n];
if (o._enabled && o.node && o.node._activeInHierarchy) ++n; else {
t.removeAt(n);
e && (o._objFlags &= ~e);
}
}
...
"../label/CCSGLabel": 203,
"../label/CCSGLabelCanvasRenderCmd": 203,
"../label/CCSGLabelWebGLRenderCmd": 203
} ],
49: [ (function(t, e, i) {
var n = cc.Class({
...
"../../clipping-nodes/CCClippingNode": 203,
"../../clipping-nodes/CCClippingNodeCanvasRenderCmd": 203,
"../../clipping-nodes/CCClippingNodeWebGLRenderCmd": 203,
"../../shape-nodes/CCDrawNode": 203
} ],
52: [ (function(t, e, i) {
var n = cc.Enum({
Unified: 0,
...
"../label/CCHtmlTextParser": 85,
"../label/CCTextUtils": 86
} ],
58: [ (function(t, e, i) {
...
"../videoplayer/CCSGVideoPlayer": 203
} ],
69: [ (function(t, e, i) {
var n = cc.Class({
name: "cc.ViewGroup",
...
"./CCAnimation": 40,
"./CCAudioSource": 41,
"./CCBlockInputEvents": 42,
"./CCButton": 43,
"./CCCanvas": 44,
"./CCComponent": 45,
"./CCComponentEventHandler": 46,
"./CCEditBox": 47,
"./CCLabel": 48,
"./CCLabelOutline": 49,
"./CCLayout": 50,
...
"./CCSlider": 61,
"./CCSprite": 62,
"./CCSpriteDistortion": 63,
"./CCToggle": 65,
"./CCToggleContainer": 66,
"./CCToggleGroup": 67,
"./CCVideoPlayer": 68,
"./CCWebView": 70,
"./CCWidget": 71,
...
var o = t("./json-unpacker"), r = t("../utils/misc").pushToMap, s = {}, c = {}, a = {}, l = 0, h = 2, u = 3;
e.exports = {
...
"../../../external/box2d/box2d": 203,
"./CCPhysicsContact": 104,
"./CCPhysicsManager": 105,
"./CCRigidBody": 108,
"./collider/CCPhysicsBoxCollider": 109,
"./collider/CCPhysicsChainCollider": 110,
"./collider/CCPhysicsCircleCollider": 111,
"./collider/CCPhysicsCollider": 112,
"./collider/CCPhysicsPolygonCollider": 113,
"./joint/CCDistanceJoint": 115,
"./joint/CCJoint": 116,
"./joint/CCMotorJoint": 117,
"./joint/CCMouseJoint": 118,
"./joint/CCPrismaticJoint": 119,
"./joint/CCRevoluteJoint": 120,
"./joint/CCRopeJoint": 121,
"./joint/CCWeldJoint": 122,
"./joint/CCWheelJoint": 123,
"./platform/CCPhysicsAABBQueryCallback": 203,
"./platform/CCPhysicsContactListner": 203,
"./platform/CCPhysicsDebugDraw": 203,
"./platform/CCPhysicsRayCastCallback": 203,
"./platform/CCPhysicsUtils": 203
} ],
115: [ (function(t, e, i) {
var n = t("../CCPhysicsTypes").PTM_RATIO, o = cc.Class({
...
var c = i("../assets/CCAsset"), a = i("./utils").callInNextTick, l = i("../load-pipeline/CCLoader"), h = i("../load-pipeline/pack-downloader"), u = i("../load-pipeline/auto-release-utils"), d = i("../utils/decode-uuid"), f = i("../load-pipeline/md5-pipe"), _ = "", p = "", g = {}, y = {
...
"../assets/CCAsset": 17,
"../load-pipeline/CCLoader": 87,
"../load-pipeline/auto-release-utils": 90,
"../load-pipeline/md5-pipe": 96,
"../load-pipeline/pack-downloader": 97,
...
"../utils/mutable-forward-iterator": 152,
"./id-generater": 137
} ],
142: [ (function(i, n, o) {
function r(t, e, i, n) {
...
console.error("node._components1", t._components);
}
function c(t, e, i) {
if (t._components) if (e._sealed) for (var n = 0; n < t._components.length; ++n) {
...
} else console.error("node._components2", t._components);
}
function a(t, e) {
for (var i = 0; i < t.length; ++i) {
var n = t[i], o = s(n, e);
...
"./CCAffineTransform": 155,
"./CCColor": 156,
"./CCPointExtension": 157,
"./CCRect": 158,
"./CCSize": 159,
"./CCTypes": 160,
"./CCTypesWebGL": 161,
...
"./CCSGMotionStreak": 203,
"./CCSGMotionStreakWebGLRenderCmd": 203
} ],
167: [ (function(t, e, i) {
var n = cc.Class({
...
"./CCParticleAsset": 167,
"./CCSGParticleSystem": 203,
"./CCSGParticleSystemCanvasRenderCmd": 203,
"./CCSGParticleSystemWebGLRenderCmd": 203
} ],
169: [ (function(t, e, i) {
t("./CCSGTMXLayer");
...
"./CCSGTMXLayer": 203,
"./CCTMXLayerCanvasRenderCmd": 203,
"./CCTMXLayerWebGLRenderCmd": 203
} ],
170: [ (function(t, e, i) {
t("./CCTiledMapAsset");
t("./CCTiledLayer");
...
"./cocos2d/core": 84,
"./cocos2d/core/components/CCStudioComponent": 64,
"./cocos2d/deprecated": 165,
"./cocos2d/motion-streak/CCMotionStreak": 166,
"./cocos2d/particle/CCParticleAsset": 167,
"./cocos2d/particle/CCParticleSystem": 168,
"./cocos2d/tilemap/CCTiledMap": 170,
"./cocos2d/tilemap/CCTiledMapAsset": 171,
"./extensions/ccpool/CCNodePool": 174,
"./extensions/ccpool/CCPool": 175,
"./extensions/dragonbones": 179,
"./extensions/spine": 182,
"./external/chipmunk/chipmunk": 203
} ],
174: [ (function(t, e, i) {
...
"./ArmatureDisplay": 176,
"./CCArmatureDisplay": 203,
"./CCFactory": 203,
"./CCSlot": 203,
"./CCTextureData": 203,
"./DragonBonesAsset": 177,
"./DragonBonesAtlasAsset": 178,
"./lib/dragonBones": 203
} ],
180: [ (function(i, n, o) {
var r = cc.Enum({
...
"./SGSkeleton": 203,
"./SGSkeletonAnimation": 203,
"./SGSkeletonCanvasRenderCmd": 203,
"./SGSkeletonTexture": 203,
"./SGSkeletonWebGLRenderCmd": 203,
"./Skeleton": 180,
"./SkeletonData": 181,
"./lib/spine": 203
} ],
...
"../CCDebugger": 1,
"../DebugInfos": 2,
"../cocos2d/core/event": 79,
"../cocos2d/core/event-manager/CCEvent": 74,
"../cocos2d/core/platform/CCMacro": 129,
"../cocos2d/core/platform/js": 141,
"../cocos2d/core/utils/find": 150,
"../cocos2d/core/utils/mutable-forward-iterator": 152,
"../cocos2d/core/value-types": 164,
"../extends": 173,
"../polyfill/misc": 204,
"../polyfill/string": 205,
...
"./jsb-loader": 195,
"./jsb-particle": 196,
"./jsb-scale9sprite": 197,
"./jsb-spine": 198,
"./jsb-tex-sprite-frame": 199,
"./jsb-tiledmap": 200,
"./jsb-videoplayer": 201,
"./jsb-webview": 202
} ],
...
"../cocos2d/core/component-scheduler": 39,
"../cocos2d/core/event/event-listeners": 76,
"../cocos2d/core/load-pipeline/auto-release-utils": 90,
"../cocos2d/core/node-activator": 103
} ],
188: [ (function(t, e, i) {
...
"../cocos2d/core/platform/CCClass": 126
} ],
200: [ (function(t, e, i) {
"use strict";
if (!cc.runtime) {
